...
| **v0.1.17** | Maintainability + eval substrate consolidation (deferred from v0.1.15 round-0 over-scoping). W-29 cli.py mechanical split (9927 LOC at v0.1.17 cycle-open HEAD `df6a13c`; was 9217 LOC at v0.1.14 RELEASE_PROOF deferred-W-29 baseline; +710 LOC across v0.1.14/v0.1.15/v0.1.15.1 surface adds — F-PLAN-R2-05 round-2 LOC-baseline correction) + W-30 regression test + W-AH-2 scenario expansion 35 → 120+ + W-AI-2 `hai eval review` CLI + W-AM-2 4 fork-deferred escalate-tagged scenarios + W-Vb-4 persona-replay residual P7..P12 + F-PV14-02 (`hai sync purge`) + W-B (`hai intake weight` body-comp surface + table) + W-D arm-2 + W-C-EQP query-plan assertions. **Ship claim:** internal correctness + maintainer-side cleanup. Parallelizable with v0.2.0 since v0.2.0 hard deps do not include v0.1.17 work. See `reporting/plans/v0_1_17/README.md`. | next-active (post-v0.1.15.1) | 2026-Q3 late / Q4 early | v0.1.15 (W-A + W-C in tree). **Former v0.1.16 precondition retired 2026-05-04** — W-AH-2 consolidates against synthetic + dogfood evidence, not foreign-user transcript. |
