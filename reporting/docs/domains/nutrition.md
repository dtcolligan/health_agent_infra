...
| Projector | `src/health_agent_infra/core/state/projectors/nutrition.py` |
...
- `verification/tests/test_nutrition_classify.py`
- `verification/tests/test_nutrition_policy.py`
- `verification/tests/test_nutrition_skill_gates.py`
