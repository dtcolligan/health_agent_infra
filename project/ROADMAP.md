...
frame is [`FRAME.md`](FRAME.md); the locked paper frame
...
|---|---|
| Frame locked | `FRAME.md`, `DECISIONS.md`, `PAPER_FRAME.md`, and cold-start docs agree. |
...
HAI release history remains under [`../hai/reporting/plans/`](../hai/reporting/plans/).
