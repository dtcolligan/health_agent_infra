...
| **v0.2.0** | **Ship-prep complete 2026-05-07** — Wave 2 gateway: provenance + weekly review + deterministic factuality. 11 W-ids closed: W-PROV-2 (locator emission across 5 dormant domains, hybrid emission per maintainer option C) + W-EVCARD-DAILY (migration 027 daily evidence card) + W-EVCARD-WEEKLY (migration 028 append-only weekly claim card) + W52 (`hai review weekly` aggregation surface) + W-FACT-ATOM (atomic-claim parser, 100% precision over 30-fixture corpus) + W58D (deterministic factuality gate, 100/100 vs 97/99 thresholds over 160-fixture corpus) + W-MCP-THREAT + W-COMP-LANDSCAPE + W-NOF1-METHOD + W-EXPLAIN-UX-CARRY (6 obligations consumed in W52). W-2U-GATE-2 did NOT fire (opportunistic-not-blocking per D16). Plus W-FACT-ATOM-discovered F-PLAN-10 alignment fix (4 hidden W52 alignment holes in qualitative atoms — closed in `bfc8722`). D14 4 rounds 10→5→3→1nit. PyPI publish gated on D15 IR settle + maintainer manual TTY gate. See `reporting/plans/v0_2_0/RELEASE_PROOF.md`. | shipped 2026-05-07 | shipped (PyPI gated) | v0.1.14 (W-PROV-1 + W-AJ); **NOT** dependent on v0.1.17/v0.1.18 |
| **v0.2.1** | Insight ledger (W53) (Path A) — **next-active cycle.** | post-v0.2.0 + 2-3 weeks | 2026-Q4 / 2027-Q1 | v0.2.0 (W52 surface + W-EVCARD-WEEKLY substrate, both shipped) |
...
| W-id | Title | Effort | Source |
|---|---|---|---|
| **W-29** | cli.py mechanical split (9927 LOC at v0.1.17 cycle-open HEAD `df6a13c`; was 9217 LOC at v0.1.14 RELEASE_PROOF deferred-W-29 baseline — F-PLAN-R2-05 round-2 corrected this attribution; the v0.1.13 W-29-prep boundary-table baseline was 8891 LOC per `reporting/docs/archive/cycle_artifacts/cli_boundary_table.md:55`; the 9217 number reflects post-v0.1.13-ship + W-AA + W-FBC-2 intra-v0.1.13 surface adds; +710 LOC across v0.1.14/v0.1.15/v0.1.15.1 surface adds; byte-stable manifest contract) | 4-6d | v0.1.14 RELEASE_PROOF §carry-overs; redestinated v0.1.15 → v0.1.17 on 2026-05-02 evening |
