...
[`hai/src/health_agent_infra/core/pull/`](../../hai/src/health_agent_infra/core/pull/).
...
([`garmin.py`](../../hai/src/health_agent_infra/core/pull/garmin.py)), the
preferred live intervals.icu adapter
([`intervals_icu.py`](../../hai/src/health_agent_infra/core/pull/intervals_icu.py)),
and the best-effort Garmin Connect adapter
([`garmin_live.py`](../../hai/src/health_agent_infra/core/pull/garmin_live.py)).
...
[`hai/src/health_agent_infra/core/intake/`](../../hai/src/health_agent_infra/core/intake/)
...
[`cli.py :: cmd_pull`](../../hai/src/health_agent_infra/cli.py) for the dispatch.

Conformers are checked structurally against
[`core/pull/protocol.py :: FlagshipPullAdapter`](../../hai/src/health_agent_infra/core/pull/protocol.py):
...
[`hai/verification/tests/test_pull_garmin_live.py`](../../hai/verification/tests/test_pull_garmin_live.py).
...
[`clean_inputs()`](../../hai/src/health_agent_infra/core/clean/recovery_prep.py)
...
- **`raw_daily_row` is the source-of-truth row.** This is what gets
  ...
  tuple in
  [`core/pull/garmin_live.py`](../../hai/src/health_agent_infra/core/pull/garmin_live.py);
...
[`hai/src/health_agent_infra/data/garmin/export/`](../../hai/src/health_agent_infra/data/garmin/export/).
...
[`project_source_daily_garmin()`](../../hai/src/health_agent_infra/core/state/projector.py).
...
1. **Same evidence shape, reuse Garmin projectors.** If the new
   ...
   ([`recovery`](../../hai/src/health_agent_infra/core/state/projectors/recovery.py),
   [`sleep`](../../hai/src/health_agent_infra/core/state/projectors/sleep.py),
   [`stress`](../../hai/src/health_agent_infra/core/state/projectors/stress.py),
   [`strength`](../../hai/src/health_agent_infra/core/state/projectors/strength.py)).
...
- **Live-path auth.** If the adapter needs credentials, model them
  on
  [`core/pull/auth.py`](../../hai/src/health_agent_infra/core/pull/auth.py) —
...
- **`_SOURCE_DAILY_GARMIN_COLUMNS`** in
  [`projector.py`](../../hai/src/health_agent_infra/core/state/projector.py).
...
- **Skill files.** Skills under
  [`hai/src/health_agent_infra/skills/`](../../hai/src/health_agent_infra/skills/)
...
- `hai/verification/tests/test_pull_<source>.py` (or the CSV/live split if the
...
- At least one test exercises the full `pull → clean → project`
  ...
  [`test_state_clean_projection.py`](../../hai/verification/tests/test_state_clean_projection.py)
...
- If the adapter introduces credentials, mirror the
  [`test_pull_auth.py`](../../hai/verification/tests/test_pull_auth.py) +
  [`test_cli_pull_live_and_auth.py`](../../hai/verification/tests/test_cli_pull_live_and_auth.py)
