...
frame is in [`../../project/FRAME.md`](../../project/FRAME.md) and
[`../../project/OPERATING_MODEL.md`](../../project/OPERATING_MODEL.md).
For the active paper title, venue, and mechanism inventory, see
[`../../research/runtime_contracts_paper/framing_v2/CONVERGED.md`](../../research/runtime_contracts_paper/framing_v2/CONVERGED.md);
this file explains the runtime contract HAI contributes to that frame.
...
[`hai/docs/architecture.md`](hai/docs/architecture.md).
...
[`hai/docs/agent_cli_contract.md`](hai/docs/agent_cli_contract.md).
...
- [`hai/docs/architecture.md`](hai/docs/architecture.md) - full pipeline
- [`hai/docs/explainability.md`](hai/docs/explainability.md) - three-state audit detail
- [`hai/docs/x_rules.md`](hai/docs/x_rules.md) - X-rule catalogue
- [`hai/docs/state_model_v1.md`](hai/docs/state_model_v1.md) - state schema
- [`hai/docs/non_goals.md`](hai/docs/non_goals.md) - scope discipline
- [`hai/docs/tour.md`](hai/docs/tour.md) - 10-minute reading tour
