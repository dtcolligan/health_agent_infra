...
`hai/src/health_agent_infra/core/explain/queries.py`.
...
`hai/src/health_agent_infra/core/explain/queries.py` (`_PHASE_B_TIERS`).
...
- `hai/src/health_agent_infra/core/explain/queries.py` — read-only
  loaders, dataclasses, and the supersession lookup.
- `hai/src/health_agent_infra/core/explain/render.py` — JSON shape and
  human-readable renderer.
- `hai/src/health_agent_infra/cli.py` — `hai explain` subcommand wiring.
- `hai/verification/tests/test_cli_explain.py` — end-to-end CLI tests covering
