...
[`intent-router`](../../hai/src/health_agent_infra/skills/intent-router/SKILL.md)
...
`hai/src/health_agent_infra/skills/` are not prose decoration. They are
...
specifics live in the [`safety` skill](../../hai/src/health_agent_infra/skills/safety/SKILL.md).
