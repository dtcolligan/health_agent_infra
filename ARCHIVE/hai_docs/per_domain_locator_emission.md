...
`hai/reporting/plans/v0_2_0/w_prov_2_spike.md`. The maintainer adopted
...
Per W-PROV-1 (`hai/reporting/docs/archive/cycle_artifacts/source_row_provenance.md:42-46`)
...
`hai/verification/tests/test_provenance_whitelist_against_synthesis.py`
