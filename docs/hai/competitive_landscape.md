...
`reporting/plans/historical/multi_release_roadmap.md` (2026-04-25)
with 2026-Q2 evidence. The five competitor categories below match
`reporting/plans/post_v0_1_18/strategic_plan_v2.md` §2.1; the five
...
- **`reporting/plans/post_v0_1_18/strategic_plan_v2.md`** §2.1
