...
| Release auditor / maintainer | [`current_system_state.md`](current_system_state.md), [`../../AUDIT.md`](../../AUDIT.md), [`../../ROADMAP.md`](../../ROADMAP.md), [`../../reporting/plans/README.md`](../../reporting/plans/README.md) |
...
`reporting/plans/v0_*/`, launch drafts under `reporting/docs/launch/`,
...
[`../../reporting/docs/archive/doctrine/`](../../reporting/docs/archive/doctrine/) holds pre-rebuild
doctrine docs (canonical_doctrine.md, chief_operational_brief,
founder_doctrine, phase_timeline). [`../../reporting/docs/archive/cycle_artifacts/`](../../reporting/docs/archive/cycle_artifacts/)
