...
`hai_0_1_18_drift.json` is the deliberately stale L7 drift snapshot.
It is generated by:
...
embedded manifest remains `agent_cli_contract.v1`; benchmark harnesses
must treat it as stale contract input, not as a runtime downgrade.
