...
``project/ROADMAP.md`` saying "v0.1.8 current" three releases late;
...
_FRESHNESS_PATTERNS: tuple[tuple[str, str], ...] = (
    # project/ROADMAP.md historically said "v0.1.8 current."
    ("project/ROADMAP.md", r"\*\*v(\d+\.\d+\.\d+)\s+current\.\*\*"),
)
...
_CURRENT_CYCLE_PLAN = REPO_ROOT / "hai/reporting/plans/v0_1_14/PLAN.md"

_FRESHNESS_W_ID_SURFACES: tuple[str, ...] = (
    "project/ROADMAP.md",
    "hai/reporting/plans/tactical_plan_v0_1_x.md",
    "hai/reporting/plans/strategic_plan_v1.md",
)
