...
Per Phase 0 finding F-PHASE0-07 (`hai/reporting/plans/v0_1_17/audit_findings.md`):
...
explicitly:
    uv run pytest hai/verification/tests/test_w_vb_4_persona_matrix_baseline.py -q
"""
