...
def test_committed_contract_doc_matches_generated():
    """The committed hai/docs/agent_cli_contract.md must match
    what render_markdown produces now. If this fails, regenerate:

        hai capabilities --markdown > hai/docs/agent_cli_contract.md
    ...
    path = Path("hai/docs/agent_cli_contract.md")
    if not path.exists():
    ...
    assert current == committed, (
        ...
        "hai/docs/agent_cli_contract.md"
    )
