...
invariants from ``hai/docs/grounded_expert_scope.md``:
    ...
    if query.topic not in ALLOWLISTED_TOPICS:
        return RetrievalResult(
            ...
            abstain_reason=(
                ...
                f"see hai/docs/grounded_expert_scope.md §2"
            ),
        )
