...
``hai/docs/grounded_expert_scope.md`` together, so the scope and
...
See ``hai/docs/grounded_expert_scope.md`` §2 for the policy this
module enforces.
"""
...
SOURCES: tuple[Source, ...] = (
    Source(
        ...
        origin_path="hai/src/health_agent_infra/domains/recovery/classify.py",
        excerpt=(
    ...
    Source(
        ...
        origin_path="hai/docs/x_rules.md",
        excerpt=(
    ...
    Source(
        ...
        origin_path="hai/src/health_agent_infra/skills/recovery-readiness/SKILL.md",
        excerpt=(
