...
layers. See ``hai/docs/memory_model.md`` §2.1 and
``hai/reporting/plans/historical/post_v0_1_roadmap.md`` §5 Phase D for framing.
...
``hai/reporting/plans/historical/post_v0_1_roadmap.md`` §3.1 decision 4.
"""
