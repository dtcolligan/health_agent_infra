...
# Names referenced by `hai/docs/intervals_icu_403_triage.md`;
...
OUTCOME_NEXT_STEPS: dict[str, str] = {
    ...
    "CAUSE_1_CLOUDFLARE_UA": (
        ...
        "`hai/docs/intervals_icu_403_triage.md` (CAUSE_1)."
    ),
    "CAUSE_2_CREDS": (
        ...
        "`hai/docs/intervals_icu_403_triage.md` (CAUSE_2)."
    ),
    "NETWORK": (
    ...
    "OTHER": (
        ...
        "`hai/docs/intervals_icu_403_triage.md` (OTHER)."
    ),
}
