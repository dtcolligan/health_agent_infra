...
class ProposalReplaceRequired(ValueError):
    ...
    Per D1 (``hai/reporting/plans/v0_1_4/D1_re_author_semantics.md``), silent
...
def project_proposal(
    ...
    *,
    ...
    Per D1 (``hai/reporting/plans/v0_1_4/D1_re_author_semantics.md``):
...
def mark_plan_superseded(
    ...
    *,
    ...
    Per D1 (``hai/reporting/plans/v0_1_4/D1_re_author_semantics.md``) and
