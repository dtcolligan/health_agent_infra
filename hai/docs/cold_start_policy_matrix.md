...
> Ships alongside `hai/verification/tests/test_cold_start_policy_matrix.py`
...
### Nutrition — DOES NOT RELAX (`domains/nutrition/classify.py:162-188`; `hai/verification/tests/test_nutrition_cold_start_non_relaxation.py`)
...
`hai/verification/tests/test_cold_start_policy_matrix.py` pins each row of
