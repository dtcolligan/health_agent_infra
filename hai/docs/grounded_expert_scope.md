...
|---|---|---|
| `internal_state_model` | band definitions, projector semantics, missingness grammar | `hai/docs/state_model_v1.md`, `hai/src/health_agent_infra/domains/*/classify.py` |
| `internal_x_rules` | X-rule triggers and tiers | `hai/docs/x_rules.md`, `hai/src/health_agent_infra/core/synthesis_policy.py` |
| `internal_skill_contract` | what a skill is and is not allowed to do when it composes rationale over a shipped signal (e.g. Garmin body battery) | `hai/src/health_agent_infra/skills/**/SKILL.md` |
...
- `hai/verification/tests/test_expert_research.py::test_every_source_origin_exists`
