...
| Surface | Path |
|---|---|
| Schemas | `hai/src/health_agent_infra/domains/running/schemas.py` |
| Classifier | `hai/src/health_agent_infra/domains/running/classify.py` |
| Policy | `hai/src/health_agent_infra/domains/running/policy.py` |
| Signals | `hai/src/health_agent_infra/domains/running/signals.py` |
| Projector | `hai/src/health_agent_infra/core/state/projectors/running_activity.py` plus accepted daily projection in `core/state/projector.py` |
| Skill | `hai/src/health_agent_infra/skills/running-readiness/SKILL.md` |
...
- `hai/verification/tests/test_running_classify.py`
- `hai/verification/tests/test_running_policy.py`
- `hai/verification/tests/test_running_cold_start_policy.py`
- `hai/verification/tests/test_running_skill_gates.py`
