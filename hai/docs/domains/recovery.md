...
| Surface | Path |
|---|---|
| Schemas | `hai/src/health_agent_infra/domains/recovery/schemas.py` |
| Classifier | `hai/src/health_agent_infra/domains/recovery/classify.py` |
| Policy | `hai/src/health_agent_infra/domains/recovery/policy.py` |
| Projector | `hai/src/health_agent_infra/core/state/projectors/recovery.py` |
| Manual intake | `hai/src/health_agent_infra/domains/recovery/readiness_intake.py` |
| Skill | `hai/src/health_agent_infra/skills/recovery-readiness/SKILL.md` |
...
- `hai/verification/tests/test_recovery_classify.py`
- `hai/verification/tests/test_recovery_policy.py`
- `hai/verification/tests/test_source_row_locator_recovery.py`
- `hai/verification/tests/test_recovery_skill_gates.py`
