...
[`../../project/DECISIONS.md`](../../project/DECISIONS.md); personal
...
|---|---|---|
| **Runtime analyst** | Pull, clean, project, classify, policy, synthesis mutation, persistence. All deterministic. | Python code under `hai/src/health_agent_infra/core/` + `domains/<d>/` |
| **Coach** | Composing rationale for an already-fixed action, surfacing uncertainty, asking clarifying questions during narration. Judgment only. | Markdown skills under `hai/src/health_agent_infra/skills/` |
