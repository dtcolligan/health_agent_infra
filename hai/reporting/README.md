...
active HAI documentation lives in [`../docs/`](../docs/).
...
and [`../../benchmark/governed_agent_bench/`](../../benchmark/governed_agent_bench/).
Use `hai/reporting/` for release proof and historical planning provenance.

This directory has four subdirectories, each with a distinct role. Current
HAI docs are outside this tree at [`../docs/`](../docs/).

## Subdirectories

| Path | Class | Role |
|---|---|---|
| [`docs/`](docs/) | legacy docs location | Historical docs archive and launch drafts retained so old references resolve. Active HAI docs live at [`../docs/`](../docs/). |
...
- No tests or evals. Those live under
  ...
  inside the wheel at `hai/src/health_agent_infra/evals/`).
