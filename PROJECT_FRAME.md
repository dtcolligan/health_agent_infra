...
| HAI | Personal-wellness reference runtime, packaged as `health-agent-infra` and exposed through `hai`. | `README.md`, `reporting/docs/`, `src/health_agent_infra/` |
...
5. `README.md`
6. `reporting/docs/current_system_state.md`
7. `ROADMAP.md`
